    ...
    title:
      {
        ...
        [TipoHistorico.AVALIACAO_MEMBRO_AUXILIAR]: "Minuta do membro auxiliar",
        [TipoHistorico.DECISAO]: "Decisão do Corregedor",
        [TipoHistorico.AVALIACAO_COM_FORCA_DE_DECISAO]: "Decisão direta do Corregedor",
        [TipoHistorico.AVALIACAO_REMOVIDA]: "Minuta devolvida",
        ...
        [TipoHistorico.RASCUNHO_AVALIACAO_SALVO]: "Rascunho de minuta salvo",
        [TipoHistorico.RASCUNHO_AVALIACAO_DESCARTADO]: "Rascunho de minuta descartado",
